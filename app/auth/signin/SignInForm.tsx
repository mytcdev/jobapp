...
export default function SignInForm() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6">
      ...
      <div className="bg-white border rounded-xl p-8 w-full max-w-sm flex flex-col gap-3 shadow-sm">
        <button
          onClick={() => signIn("google", { callbackUrl })}
          className="flex items-center justify-center gap-3 border rounded-lg px-4 py-2.5 text-sm font-medium hover:bg-gray-50 transition-colors"
        >
          <GoogleIcon />
